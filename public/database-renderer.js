...
contextBridge.exposeInMainWorld('databaseApi', {
  ...
  findWordsByRange: (database, side, corpusId, wordLimit, wordSkip) => ipcRenderer.invoke(`${ChannelPrefix}:findWordsByRange`, database, side, corpusId, wordLimit, wordSkip)
});
